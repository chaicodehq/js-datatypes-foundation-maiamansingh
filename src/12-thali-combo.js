...
export function createThaliDescription(thali) {
  if(typeof thali !== "object"  || thali ===  null ||typeof thali.name !== "string" || !Array.isArray(thali.items) ||typeof thali.price !== "number" ||typeof thali.isVeg !== "boolean" ){    //name (string), items (array), price (number), isVeg (boolean)
...
export function searchThaliMenu(thalis, query) {
  ...
  return thalis.filter(thali => {
    ...
    const itemsMatch = thali.items.some(item => item.toLowerCase().includes(q));
